/** Step 11 — Real staging partner lifecycle + ETA-label cert (Cloud Run Job — /app absolute imports). */
...
import { providerService } from "/app/src/services/provider.service.ts";
...
import { ML_FEATURE_SINK_CONSUMER_NAME } from "/app/src/events/consumers/ml-feature-sink.consumer.ts";
