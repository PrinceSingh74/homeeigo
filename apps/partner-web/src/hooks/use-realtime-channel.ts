 ...
 * admin console + customer web). Multiple subscribers to the same channel
 * (dashboard tracking publisher, nav screen, bridges) reuse one connection.
 */
...
export function useRealtimeChannel({
  ...
  // (The GPS tracking publisher depends on this.)
