...
export function WalletTopBar() {
  ...
  const { walletUser } = useWalletDerived();
    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-0.5 sm:gap-1.5">
        ...
        <button
          ...
          className="hidden h-9 items-center gap-1.5 rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 px-3 text-xs font-semibold text-white shadow-[0_4px_12px_rgb(16_185_129/0.25)] min-[420px]:flex"
        >
          <Gift size={14} />
          Refer
        </button>
