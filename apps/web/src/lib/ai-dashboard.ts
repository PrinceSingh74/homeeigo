...
export const AI_HOME_STATUS: AiHomeStatusItem[] = [
  ...
  },
  {
    ...
    valueColor: "text-cyan-600 dark:text-cyan-300",
    progress: 100,
  },
  {
    id: "safety",
  ...
  },
  {
    ...
    chip: "AI Live",
    tone: "violet",
    iconGradient: "from-violet to-pink",
    hoverGlow: "hover:shadow-[0_12px_32px_rgb(124_58_237/0.2)]",
    valueColor: "text-violet dark:text-violet-300",
    progress: 100,
...
export const AI_INSIGHTS = [
  {
    ...
    border: "border-[#DBEAFE] dark:border-blue-500/25",
...
export const AI_PREDICTIONS = [
  { id: "deep", label: "Deep Cleaning", gradient: "from-violet to-purple-600" },
  { id: "filter", label: "Water Filter", gradient: "from-primary to-blue-600" },
  { id: "ac", label: "AC Service Due", gradient: "from-cyan to-cyan-600" },
